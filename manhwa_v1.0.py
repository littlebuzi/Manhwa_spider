...
for num1 in range(1,1031):
    ...
    os.makedirs('D://manhua//整站爬取www.manhwa.cc//整站漫画爬取//' + str(num1) +'.'+ book_name_clean )
    ...
    for item in soup.select('.d_menu>ul>li'):
        ...
        for a in item.find_all('a'):
            ...
            for i, v in enumerate(count):
                ...
                with open('D://manhua//整站爬取www.manhwa.cc//整站漫画爬取//' + book_name_clean + '//'+ str(title) + '//' +str(i) + '.jpg', 'wb') as file:
